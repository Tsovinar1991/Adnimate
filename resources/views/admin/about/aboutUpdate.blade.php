...
@section('content')
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{url('admin/about/'.$about->id)}}">
        ...
        <div class="form-group{{ $errors->has('meta_id') ? ' has-error' : '' }}">
            ...
            <div class="col-md-10">
                <input id="meta_id" type="text" class="form-control" name="meta_id" value="{{ $about->meta_id }}"
                       required autofocus>
        ...
        <div class="form-group{{ $errors->has('name_ru') ? ' has-error' : '' }}">
            ...
            <div class="col-md-10">
                <input id="name" type="text" class="form-control" name="name_ru" value="{{ $about->name_ru }}" required
                       autofocus>
        ...
        <div class="form-group{{ $errors->has('name_am') ? ' has-error' : '' }}">
            ...
            <div class="col-md-10">
                <input id="name_am" type="text" class="form-control" name="name_am" value="{{ $about->name_am }}"
                       required autofocus>
        ...
        <div class="form-group{{ $errors->has('name_en') ? ' has-error' : '' }}">
            ...
            <div class="col-md-10">
                <input id="name_en" type="text" class="form-control" name="name_en" value="{{ $about->name_en }}"
                       required autofocus>
        ...
        <div class="form-group{{ $errors->has('description_am') ? ' has-error' : '' }}">
            ...
            <div class="col-md-10">
                <textarea id="description_am" class="form-control mytextarea"
                          name="description_am">{{ $about->description_am }}</textarea>
                <input name="image" type="file" id="upload" class="hidden" onchange="">

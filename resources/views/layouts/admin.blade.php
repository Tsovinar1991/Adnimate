    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{url('/admin/insert/aboutUs')}}"> <i class="fas fa-users-cog"></i> About Us</a>
                <a class="dropdown-item" href=""><i class="fas fa-apple-alt"></i> Products</a>
